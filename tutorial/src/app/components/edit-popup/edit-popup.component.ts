...
@Component({
  ...
  standalone: true,
  imports: [DialogModule, CommonModule, FormsModule, RatingModule, ButtonModule], //CommonModule Exports all the basic Angular directives and pipes(NgIf, NgForOf, DecimalPipe, etc.)
